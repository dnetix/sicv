    ...
    <div class="leftpanelinner">
        ...
        <div class="visible-xs hidden-sm hidden-md hidden-lg">
            <div class="media userlogged">
                <img alt="" src="{{ public_assets('images/profile/user.png') }}" class="media-object">
        ...
        <ul class="nav nav-pills nav-stacked nav-bracket">
            <li class="active"><a href=""><i class="fa fa-home"></i> <span>Panel Principal</span></a></li>
            <li class="nav-parent"><a href="index.php"><i class="fa fa-edit"></i> <span>Contrato</span></a>
                <ul class="children">
